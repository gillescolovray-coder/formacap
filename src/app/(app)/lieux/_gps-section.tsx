...
export function GpsSection({ location }: Props) {
  ...
  async function handleGeocode() {
    ...
    // Récupère l'adresse depuis le DOM (champs adresse / postal_code / city)
    // pour ne pas dupliquer l'état.
    const form =
      typeof document !== "undefined"
        ? (document.querySelector("form#form-location") as HTMLFormElement | null) ??
  ...
  return (
    <div className="rounded-lg bg-blue-50/40 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 p-4 space-y-4">
      ...
      {/* Champs cachés pour la soumission form */}
