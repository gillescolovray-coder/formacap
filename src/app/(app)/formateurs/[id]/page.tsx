...
export default async function TrainerDetailPage({
  ...
  const [
    ...
    supabase
      .from("formations")
      .select("id, title, modality, category:formation_categories(id, name)")
      .eq("status", "published")
  ...
  // portail via TrainerPortalSection ci-dessous (1 clic = token créé
  // + email d'invitation envoyé au formateur).
