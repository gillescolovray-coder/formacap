    ...
    <div className="min-h-screen bg-zinc-50">
      <header className="bg-white border-b border-zinc-200">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center gap-4 flex-wrap">
          {/* Cas 1 : le partenaire a son propre logo → affichage cobranding
              « Logo partenaire / En partenariat avec / Logo CAP NUMÉRIQUE ».
              Cas 2 : pas de logo partenaire → fallback simple (logo orga
              + nom du partenaire). */}
              ...
              <div className="flex flex-col items-center text-center">
                ...
                {ctx.organization.logo_url ? (
                  ...
                  <img
                    ...
                    className="h-10 w-auto max-w-[140px] object-contain mt-1"
                  />
                ) : (
      ...
      <footer className="max-w-3xl mx-auto px-4 py-6 text-center text-[11px] text-zinc-500">
